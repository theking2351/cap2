...
function handleGameover(){
  ...
  if (life === 0) {
    gameState=2
      ...
      text("Oops you lost the game....!!!",700,500);
      text ("Your Score is " + score,900,500);
      //imageUri("https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png"),
      //imageSize( "100x100"),
